    ...
    return (
        <section className="w-full pt-20">
            <div className=" max-w-6xl mx-auto w-full flex flex-col items-center z-50 relative">
                ...
                <h1 className=" mt-2 text-3xl md:text-5xl max-w-3xl font-semibold text-white text-center leading-none tracking-tight text-balance">
                    10x your Winning Rate with AI-Powered Predictions
                </h1>
                <p className="text-base text-balance text-muted-foreground leading-tight text-center max-w-xl mt-2">
