    ...
    return (
        <Sheet>
            <SheetTrigger asChild>
                <div className="flex items-center gap-2 rounded-full bg-muted/50 backdrop-blur-lg hover:bg-primary/10 hover:text-primary cursor-pointer py-1.5 px-2.5">
            ...
            <SheetContent side="bottom" className="bg-[#131313] rounded-t-xl w-full px-4 pt-6">
                <SheetTitle className="text-base font-semibold text-start mb-4">Choose your Preferred Plan</SheetTitle>

                <RadioGroup defaultValue="pro" className="grid gap-4" onValueChange={setSelectedPlan}>
                    <Label
                        htmlFor="free"
                        className="flex cursor-pointer flex-col rounded-xl border border-muted bg-transparent p-4 hover:bg-muted/60 hover:text-accent-foreground [&:has([data-state=checked])]:border-primary"
                    >
                        <div className="flex w-full items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="font-medium text-sm">Starter pack</span>
                            </div>
                            <span className="font-medium text-sm">Free</span>
                        </div>
                        <p className="text-sm line-clamp-1 text-muted-foreground pl-7">
                            For casual bettors getting started with basic analysis.
                        </p>
                    </Label>
                    ...
                    >
                        <div className="flex w-full items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="font-medium text-sm">Pro pack</span>
                            </div>
                            <span className="font-medium text-sm">GH₵50/mo</span>
                        </div>
                        <p className="text-sm text-muted-foreground pl-7 mb-4">
                            For serious bettors who want AI-powered insights and advanced analytics.
                        </p>
                        <ul className="space-y-3 mb-1 text-sm text-muted-foreground w-full">
                ...
                <SheetFooter className=" pt-4 pb-8">
                    {selectedPlan === "free" ? (
                        <SheetClose asChild>
...
export default UpgradePlansMobile;
