    ...
    return (
        <Sheet>
            <SheetTrigger asChild>
                <div className="flex items-center gap-2 w-fit justify-start border border-input/20 hover:border-primary/20 rounded-full bg-muted/50 backdrop-blur-lg hover:bg-primary/25 text-muted-foreground hover:text-white cursor-pointer py-2 px-3 transition-colors">
