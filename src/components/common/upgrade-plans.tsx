    ...
    return (
        <Sheet>
            <SheetTrigger asChild>
                <div className="flex items-center gap-2 w-fit justify-start rounded-full bg-muted/50 backdrop-blur-lg hover:bg-primary/20 hover:text-primary cursor-pointer py-2 px-3 transition-colors">
            ...
            <SheetContent className="bg-muted/50 backdrop-blur-md rounded-xl border border-input/20  w-full px-4 pt-6">
                ...
                <RadioGroup defaultValue="pro" className="grid gap-4" onValueChange={setSelectedPlan}>
                    <Label
                        htmlFor="free"
                        className="flex cursor-pointer flex-col rounded-xl border-2 border-muted bg-transparent p-4 hover:bg-muted/60 hover:text-accent-foreground [&:has([data-state=checked])]:border-primary"
                    >
                        ...
                        <p className="text-sm text-muted-foreground pl-7 pr-12 text-balance">
                    ...
                    >
                        ...
                        <p className="text-sm text-muted-foreground pl-7 pr-8 text-balance mb-4">
